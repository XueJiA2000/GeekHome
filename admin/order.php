...
<html>
    ...
    <body>
		...
		<!--数据动态化-->
	  	...
	  	<form action="order_deal.php?act=delAll" method="post" id="myForm">  
            <table class="tablelist">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <?php echo $result_arr["Id"]; ?> </td>
                        <td><u style="cursor:pointer"> <?php echo $result_arr["OrderNum"]; ?> </u></td>
                        <td> <?php echo $result_arr["contactName"]; ?> </td>
                        <td> <?php echo $result_arr["Contactaddress"]; ?> </td>
                        <td> <?php echo $result_arr["contactphone"]; ?> </td>
                        <td> <?php echo $result_arr["isPayOk"]; ?> </td>
                        ...
                        <td class="td-manage">
                            ...
                            <a title="order_deal.php?act=del&Id=<?php echo $result_arr["Id"];?>" class="click" style="text-decoration:none"> <i class="layui-icon">&#xe640;</i> </a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
